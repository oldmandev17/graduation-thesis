...
import { AiOutlineSearch, AiOutlineBell, AiOutlineMail, AiOutlineHeart } from 'react-icons/ai'

function Header() {
  return (
    <div className='flex flex-col'>
      <div className='flex flex-row gap-4 py-5  items-center px-28 '>
        <img src='/image/Fiverr-Logo.png' alt='logo' width='80' height='80' />
        ...
        <div className='text-gray-400 text-lg font-bold hover:text-green-500 cursor-pointer'>Orders</div>
        <div className='flex flex-row justify-center w-24 '>
          <img src='/image/roses.jpg' alt='avata' className=' rounded-full h-10 w-10 cursor-pointer' />
        </div>
      </div>
