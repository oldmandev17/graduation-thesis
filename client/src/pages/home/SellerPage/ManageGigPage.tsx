...
function ManageGigPage() {
  ...
  return (
    <div className='flex flex-col h-screen gap-5 px-48 pt-10 bg-gray-100'>
      <div className='flex flex-row justify-between'>
        <span className='text-4xl font-semibold text-gray-600'>Gigs</span>
        <button type='button' className='bg-[#00b14f] text-xs font-bold text-white rounded-lg px-2 h-7 uppercase'>
          Create a new gig +
        </button>
      </div>
      <div>
