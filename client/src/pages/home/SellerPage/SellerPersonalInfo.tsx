...
function SellerPersonalInfo() {
  ...
  return (
    <div>
      ...
      <Divider />
      <form onSubmit={handleSubmit(handleRequestSeller)} className='px-40 pb-10'>
          ...
          <div className='flex flex-col gap-5'>
            ...
            <div className='flex flex-col gap-10'>
              <div className='grid grid-cols-5 gap-20'>
                <div className='flex flex-col col-span-2 gap-2'>
                  ...
                  <p className='text-base italic text-gray-600'>
                    To help build credible and authentic connections with customers, they’ll now see your display name.
                    <br />
              ...
              <div className='grid grid-cols-5 gap-20'>
                ...
                <div className='col-span-3'>
                  <input type='text' className='w-full p-3 border border-gray-300 rounded-lg' {...register('skill')} />
                </div>
              </div>
              <div className='grid grid-cols-5 gap-20'>
                <div className='flex flex-col col-span-2 gap-2'>
          ...
          <div className='flex flex-col gap-5'>
            ...
            <div className='flex flex-col gap-10'>
              ...
              <div className='grid grid-cols-5 gap-20'>
                ...
                <div className='col-span-3'>
                  <input type='text' className='w-full p-3 border border-gray-300 rounded-lg' {...register('phone')} />
                </div>
              </div>
            </div>
            <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2 }}>
